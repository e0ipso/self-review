...
- Open [**Pair comment line numbers as either new or old**](practice-pair-comment-line-numbers-as-either-new-or-old-never-both.md) to learn about: Line comments use one complete side-specific pair; file comments use neither. #self-review #xml #line-numbers
...
- Open [**Use old vs new line numbers based on the commented line type**](practice-use-old-vs-new-line-numbers-based-on-the-commented-line-type.md) to learn about: Added/context lines use newLineStart/End; deleted lines use oldLineStart/End; exactly one pair, never both. #strikethroo #line-numbers #comments
...
### #line-numbers
- Open [**Line comments reference either old or new line numbers, never both**](practice-line-comments-reference-either-old-or-new-line-numbers-never-both.md) — Comments on added/context lines use new-line-start/end; comments on deleted lines use old-line-start/end. File-level comments have neither.
- Open [**Pair comment line numbers as either new or old**](practice-pair-comment-line-numbers-as-either-new-or-old-never-both.md) — Line comments use one complete side-specific pair; file comments use neither.
