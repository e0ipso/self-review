...
- **Keep the XSD schema in sync across its three locations** [`nodes/practice/practice-keep-the-xsd-schema-in-sync-across-its-two-locations.md`] #task-manager #xsd #sync
...
- **self-review XML schema (self-review-v2.xsd)** [`nodes/map/map-self-review-xml-schema-self-review-v1-xsd.md`] #self-review #xsd #schema
- **self-review XML v2 schema** [`nodes/map/map-self-review-xml-v1-schema.md`] #self-review #xml #schema
...
- **self-review-v2 XSD output format** [`nodes/map/map-self-review-v1-xsd-output-format.md`] #xml #schema #output
...
- **#schema (7):** Emit no wrapper elements in the XML output, Knowledge-base node kinds and frontmatter, review.xml format and XSD, self-review XML schema (self-review-v2.xsd), self-review XML v2 schema, self-review-v2 XSD output format, XSD schema location
...
- **#output (3):** Design XML output to be parsed by LLMs, self-review-v2 XSD output format, Treat self-review as a CLI-first, one-shot tool
...
- **#xsd (3):** Keep the XSD schema in sync across its three locations, self-review XML schema (self-review-v2.xsd), XSD schema location
...
- **#sync (2):** Keep file-type-utils.ts duplicates in sync across core and react, Keep the XSD schema in sync across its three locations
