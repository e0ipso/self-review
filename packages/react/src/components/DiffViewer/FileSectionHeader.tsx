...
export function FileSectionHeader({
  ...
  return (
    <div
      className='sticky top-0 z-10 flex items-center gap-2 h-10 px-3 bg-muted/80 backdrop-blur-sm border-t-2 border-b border-border cursor-pointer select-none'
