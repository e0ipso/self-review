Feature: XML Output
  ...
  Scenario: Empty review produces valid XML with all files
    ...
    And the file tree should list 7 files
  ...
  Scenario: XML contains comments with correct line references
    ...
    And the XML file element for "src/auth/login.ts" should contain 1 comment
  ...
  Scenario: XML contains comments with categories
    ...
    And I click "Finish Review"
    Then the output file should contain valid XML
    And that comment should have a category element with text "bug"
  ...
  Scenario: XML contains suggestions with original and proposed code
    ...
    And I click "Finish Review"
    Then the output file should contain valid XML
    And that comment should have a suggestion element
  ...
  Scenario: XML contains multi-line comment with correct range
    ...
    And I click "Finish Review"
    Then the output file should contain valid XML
    And that comment should have new-line-start="10" and new-line-end="15"
  ...
  Scenario: XML contains comment on deleted line with old line references
    ...
    And I click "Finish Review"
    Then the output file should contain valid XML
    And that comment should have old-line-start="8" and old-line-end="8"
  ...
  Scenario: XML validates against the XSD schema
    ...
    And I click "Finish Review"
    Then the output file should validate against ".claude/skills/self-review-apply/assets/self-review-v1.xsd"
